...
## [0.3.25](https://github.com/BenLocal/rust-sdks/compare/rust-sdks/libwebrtc@0.3.24...rust-sdks/libwebrtc@0.3.25) - 2026-01-28

### Fixed

- fix the 440->441 samples issue and pass a noop callback for release ([#848](https://github.com/BenLocal/rust-sdks/pull/848))

### Other

- allow apm >=10ms frames ([#843](https://github.com/BenLocal/rust-sdks/pull/843))
